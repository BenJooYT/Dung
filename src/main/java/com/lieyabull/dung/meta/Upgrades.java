...
public final class Upgrades {
    ...
    public static final Track DAMAGE = new Track("damage", "Melee Damage", 6, 3, 15);
    public static final Track MAGIC_DAMAGE = new Track("magic_damage", "Magic Damage", 8, 4, 15);
    public static final Track HEARTS = new Track("hearts", "Max Hearts", 8, 4, 15);
    public static final Track DEFENSE = new Track("defense", "Defense", 8, 5, 25);
    public static final Track CRIT = new Track("crit", "Crit Chance", 8, 4, 15);
    public static final Track SPEED = new Track("speed", "Move Speed", 10, 6, 20);
