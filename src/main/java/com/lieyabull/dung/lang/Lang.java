...
public final class Lang {
    ...
    private static final Map<String, Map<Language, String>> CATALOG = Map.ofEntries(
            ...
            entry("menu.cp.label", "[Combat Power]", "[Harcierő]"),
            entry("menu.cp.hover", "Open your Combat Power breakdown\n§cNeeds an active run.", "Nyisd meg a Harcierő-részletezést\n§cAktív futam kell hozzá."),
            ...
            entry("run.cpLock", "§6⚔ Dungeon attunes §e%s%% §6to your party's strength (locked for this run).", "§6⚔ A tömlöc §e%s%%§6-kal idomul a csapatod erejéhez (rögzítve erre a futamra)."),
            entry("run.cpNoMod", "§7Dungeon difficulty unmodified (party on the expected curve).", "§7A tömlöc nehézsége változatlan (a csapat a várt szinten van)."),
            ...
            entry("hud.cp", "§6✦ Power §e%s", "§6✦ Erő §e%s"),
            ...
            entry("tab.cp", "§6Combat Power §e%s   §7(§fWpn %s §7Arm %s§7)", "§6Harcierő §e%s   §7(§fFegy %s §7Pán %s§7)"),
            entry("tab.cpBreak", "   §7Shd %s Oth %s Upg %s Ton %s", "   §7Paj %s Egy %s Fej %s Ton %s"),
            ...
            // ---- Combat Power breakdown (/dung cp) ----
            entry("cp.title", "§6Combat Power — %s", "§6Harcierő — %s"),
            entry("cp.total", "§6Total §e%s", "§6Összesen §e%s"),
            entry("cp.weapon", "§fBest weapon: %s §7(%s)", "§fLegjobb fegyver: %s §7(%s)"),
            entry("cp.armor", "§fArmor (4 slots): §a%s", "§fPáncél (4 slot): §a%s"),
            entry("cp.shields", "§fShields: §b%s", "§fPajzsok: §b%s"),
            entry("cp.other", "§fOther gear: §e%s", "§fEgyéb felszerelés: §e%s"),
            entry("cp.upgrades", "§fPermanent upgrades: §d%s", "§fMaradandó fejlesztések: §d%s"),
            entry("cp.tonics", "§fShop tonics: §6%s", "§fBolti tonikok: §6%s"),
            entry("cp.mod", "§7Run modifier (locked): §e%s%%", "§7Futam-módosító (rögzítve): §e%s%%"),
            entry("cp.hint", "§8/dung cp §7to open the breakdown.", "§8/dung cp §7a részletezéshez."),
            entry("cp.noRun", "§cJoin a run first — CP breakdown needs your run loadout.", "§cElőbb csatlakozz egy futamhoz — a részletezéshez kell a futam-felszerelésed."),
            ...
            entry("gear.cp", "§6Combat Power: §e%s", "§6Harcierő: §e%s"),
